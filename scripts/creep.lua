    ...
    elseif creep_pack.stage == 1 then
        ...
        for i=1,#creep_pack.tiles do
          ...
          elseif creep_pack.fake then
            ...
            elseif (d > (3 + math.floor(3.3 * game.forces.enemy.evolution_factor)) ) then
              if math.random(1,(5 + math.floor(3.3 * game.forces.enemy.evolution_factor))) > 1 then r = 3 end -- 20% chance for biomass closer to center, 80% for fake creep
            end
          end
            if r < 3 then
