...
data:extend(
{
...

	{
		...
		max_health = 500,
		resistances = {{type = "acid", decrease = 7, percent = 35},{type = "fire", percent = 70},{type = "impact", percent = 50}},
...

	{
		...
		resistances = {{type = "acid",  decrease = 5, percent = 25},{type = "impact", percent = 40},{type = "fire",percent = 60}},
		max_health = 300,
		create_ghost_on_death = true,
		corpse = "medium-remnants",
